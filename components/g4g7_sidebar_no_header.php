<?php
/**
 * Grade 4-7 Student Dashboard Sidebar Component (No Header Version)
 * For use on My Courses page without the G4G7 header section
 */
...
// Include this file in any page that needs the G4G7 sidebar without header
// Usage: include_once('components/g4g7_sidebar_no_header.php');
?>

<!-- G4G7 Student Dashboard Sidebar (No Header Version) -->
<style>
/* G4G7 Sidebar Styles */
.g4g7-sidebar {
    position: fixed;
...
/* Navigation Content - Start from top */
.g4g7-nav-content {
    padding: 0;
    background: #ffffff;
}
