...
$PAGE->set_url(new moodle_url('/theme/remui_kids/support_videos.php'));
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="visibility-toggle <?php echo $video->visible ? 'visibility-visible' : 'visibility-hidden'; ?>"
                                            onclick="window.location.href='?action=toggle&id=<?php echo $video->id; ?>&sesskey=<?php echo sesskey(); ?>'">
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <button class="action-btn btn-delete" 
                                                onclick="if(confirm('Are you sure you want to delete this video?')) window.location.href='?action=delete&id=<?php echo $video->id; ?>&sesskey=<?php echo sesskey(); ?>'">
