<?php
/**
 * Wokwi Studio page for remui_kids theme
...
<body>
    ...
    <div class="emulator-header">
        <div class="header-left">
            ...
            <div>
                <h1 class="header-title">Wokwi Studio</h1>
                <p class="header-subtitle">Welcome, <?php echo htmlspecialchars($username); ?>! Simulate Arduino and ESP32 projects.</p>
            </div>
        </div>
    ...
    <div class="emulator-container">
        <div class="emulator-iframe-wrapper">
            ...
            <div class="loading-container" id="loading-container">
                ...
                <div class="loading-text">Loading Wokwi Studio...</div>
            </div>
