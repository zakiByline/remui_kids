<?php
/**
 * Photopea Studio page for remui_kids theme
...
<body>
    ...
    <div class="emulator-header">
        <div class="header-left">
            ...
            <div>
                <h1 class="header-title">Photopea Studio</h1>
                <p class="header-subtitle">Welcome, <?php echo htmlspecialchars($username); ?>! Professional image editing in your browser.</p>
            </div>
        </div>
    ...
    <div class="emulator-container">
        <div class="emulator-iframe-wrapper">
            ...
            <div class="loading-container" id="loading-container">
                ...
                <div class="loading-text">Loading Photopea Studio...</div>
            </div>
