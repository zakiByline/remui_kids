<?php
/**
 * SQL Lab page for remui_kids theme
...
<body>
    ...
    <div class="emulator-header">
        <div class="header-left">
            ...
            <div>
                <h1 class="header-title">SQL Lab</h1>
                <p class="header-subtitle">Welcome, <?php echo htmlspecialchars($username); ?>! Practice SQL queries in your browser.</p>
            </div>
        </div>
    ...
    <div class="emulator-container">
        <div class="emulator-iframe-wrapper">
            ...
            <div class="loading-container" id="loading-container">
                ...
                <div class="loading-text">Loading SQL Lab...</div>
            </div>
            ...
            <iframe 
                ...
                src="https://www.programiz.com/sql/online-compiler/"
